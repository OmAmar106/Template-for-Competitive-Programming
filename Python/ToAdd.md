...
* also srsly write down alll the formulas, like summation of nCr * mCx-r = n+mC in notebook

* Create a recursive segment tree code in template as well, easier to edit